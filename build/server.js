...
app.get("/app-info", function (req, res) {
  ...
  var appMainRouteStack = main._router.stack.filter(s => s.path === "").map(l => l.name) // filter out express default middlewares
  .filter(n => !(n === "query" || n === "expressInit" || n === "serveStatic")); // filter out CORS Headers
